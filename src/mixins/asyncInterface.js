...
export default function asyncInterface(TargetClass) {
  ...
  TargetClass.prototype.get = function get() {
    return this.then().get(...arguments)
  }
  TargetClass.prototype.mapSeries = function mapSeries() {
    return this.then().mapSeries(...arguments)
  }
  TargetClass.prototype.delay = function delay() {
    return this.then().delay(...arguments)
  }
