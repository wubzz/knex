...
class Builder extends EventEmitter {
  ...
  clone() {
    ...
    cloned._queryContext = this._queryContext;
  ...
  limit(value) {
    ...
    if (isNaN(val)) {
      ...
      this.__state.setSingle('limit', value);
    }
    return this;
  }
  ...
  clearSelect(){
    this.__state.clearStatement('columns');
    return this;
  }

  // Remove everything from select clause
  clearWhere(){
    this.__state.clearStatement('where');
    return this;
  }
